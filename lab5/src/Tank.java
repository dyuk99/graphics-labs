...
public class Tank extends JFrame {
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("source_folder/map.png", canvas);
    ...
    private TransformGroup getCarGroup() throws IOException {
        Shape3D shape = getModelShape3D("body", "source_folder/tank.obj");
    ...
    public static void main(String[] args) {
        try {
            ...
            TankAnimation carMovement = new TankAnimation(car);
