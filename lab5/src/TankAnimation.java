...
public class TankAnimation implements ActionListener, KeyListener {
    ...
    public TankAnimation(TransformGroup tank) {
        this.tank = tank;
        this.tank.getTransform(this.transform3D);
